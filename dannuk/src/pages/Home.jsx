    ...
    return (
        <>
            <div className='min-h-screen flex flex-col'>
                ...
                <div className='flex flex-row rounded-2xl mx-8 p-6'>
                ...
                <div className='flex md:flex-row flex-col content-center items-center md:mx-20 mx-8 mt-5 p-6 border rounded-2xl bg-teal-500 text-white gap-y-5'>
